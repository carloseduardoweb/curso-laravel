...
<form action="{{action('ProdutoController@adiciona')}}" method="post">
    ...
    <div class="form-group">
        ...
        <input id="valor" type="number" name="valor" step="0.01" min="0.01" class="form-control"  required/>
    </div>
    <div class="form-group">
        <label for="quantidade">Quantidade</label>
        <input id="quantidade" type="number" name="quantidade" min="0" class="form-control"  required/>
    </div>
    <div class="form-group">
